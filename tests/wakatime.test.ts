...
describe("Testes em api/wakatime.ts (Wakatime API)", () => {
  it("deve processar a requisição de Wakatime corretamente", async () => {
    ...
    await wakatime(req as any, res as any);

    expect(res.setHeader).toHaveBeenCalledWith("Content-Type", "image/svg+xml");
    expect(res.send).toHaveBeenCalledWith(
      renderWakatimeCard(wakaTimeData.data as any, {}),
    );
  });
