/**
 * @fileoverview Ícones SVG usados nos cards do GitHub README Stats.
 *
 * Contém os paths SVG de todos os ícones utilizados nos cards,
 * além da função para renderizar o ícone de rank do usuário.
 */

/**
 * Coleção de ícones SVG em formato de string de path SVG.
 *
 * Cada ícone corresponde a uma estatística exibida no card.
 * Os paths SVG são baseados nos ícones do GitHub Primer (16x16).
 */
const icons: Record<string, string> = {
  /** Ícone de estrela — usado para total de estrelas nos repositórios. */
  ...
  /** Ícone de commits — relógio com seta, representando histórico. */
  ...
  /** Ícone de pull requests — representação de branches sendo mescladas. */
  ...
  /** Ícone de pull requests mesclados. */
  ...
  /** Ícone de percentual de PRs mesclados — dois círculos com barra diagonal. */
  prs_merged_percentage: `<path fill-rule="evenodd" d="M13.442 2.558a.625.625 0 0 1 0 .884l-10 10a.625.625 0 1 1-.884-.884l10-10a.625.625 0 0 1 .884 0zM4.5 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5zm7 6a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm0 1a2.5 2.5 0 1 0 0-5 2.5 2.5 0 0 0 0 5z" />`,
  /** Ícone de issues — círculo com ponto de exclamação. */
  ...
  /** Ícone de discussões iniciadas — balão de chat. */
  ...
  /** Ícone de discussões respondidas — marca de verificado. */
  ...
  /** Ícone de Gist — código entre chaves. */
...
/**
 * Tipos de ícone de rank disponíveis.
 */
type TipoIconeRank = "github" | "percentile" | "default" | string;

/**
 * Retorna o SVG do ícone de rank de acordo com o tipo selecionado.
 *
 * @param tipoIcone - Tipo do ícone: "github", "percentile" ou "default".
 * @param nivelRank - Nível do rank do usuário (ex.: "A+", "S").
 * @param percentil - Percentil do rank (0-100). Exibido quando o tipo é "percentile".
 * @returns String SVG com o ícone de rank.
 *
 * @example
 * rankIcon("percentile", "A+", 12.5);
 * // → SVG com "Top" e "12.5%"
 *
 * rankIcon("github", "S", 3);
 * // → SVG com o logo do GitHub
 *
 * rankIcon("default", "B", 45);
 * // → SVG com a letra "B"
 */
const rankIcon = (
  tipoIcone: TipoIconeRank,
  nivelRank?: string,
  percentil?: number,
): string => {
  switch (tipoIcone) {
